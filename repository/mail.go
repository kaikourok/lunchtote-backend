...
type mailRepository interface {
	...
	SendAdministratorMail(targetId *int, name, title, message string) (webhooks []string, err error)
	SendMail(userId, targetId int, title, message string) (userName string, targetWebhook string, err error)
