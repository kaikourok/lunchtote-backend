...
func (u *CharacterController) TwitterOauthRequest(c *gin.Context) {
	...
	session.Set("twitter-state", state)
	session.Set("twitter-oauth-mode", mode)
	session.Set("twitter-code-verifier", codeVerifier)
